...
function getRelationshipText(live, work, visit) {
    let shipText = "";
    if (live && work && visit) {
        shipText = "Lives in, works in, visits Harrisonburg";
    } else if (live && work && !visit) {
        shipText = "Lives and works in Harrisonburg";
    } else if (live && !work && visit) {
        shipText = "Lives in and visits Harrisonburg";
    } else if (!live && work && visit) {
        shipText = "Works in and visits Harrisonburg";
    } else if (live) {
        shipText = "Lives in Harrisonburg";
    } else if (work) {
        shipText = "Works in Harrisonburg";
    } else if (visit) {
        shipText = "Visits Harrisonburg";
    }
    return shipText;
}
